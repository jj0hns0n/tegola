...
func NewRouter(a *atlas.Atlas) *httptreemux.TreeMux {
    ...
    group.UsingContext().Handler("GET", "/ogc-api-tiles/collections/:layer_name", HeadersHandler(HandleOgcApiTilesCollection{}))
    group.UsingContext().Handler("GET", "/ogc-api-tiles/collections/:layer_name/queryables", HeadersHandler(HandleLayerSchema{}))
    ...
    group.UsingContext().Handler("GET", "/ogc-api-tiles/tiles/:map_name/metadata", HeadersHandler(HandleMapCapabilities{}))
	...
	group.UsingContext().Handler("GET", "/maps/:map_name/:layer_name/queryables", HeadersHandler(HandleLayerSchema{}))
